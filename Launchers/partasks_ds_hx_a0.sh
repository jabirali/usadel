...
##################################################################
commands=( 'critical_bilayer(0.4, 0.5, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.5, 0.5, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.6, 0.5, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.7, 0.5, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.8, 0.5, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.9, 0.5, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.4, 1.0, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.5, 1.0, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.6, 1.0, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.7, 1.0, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.8, 1.0, 0.2, [ 10 0 0 ], 0, pi/4)'
           'critical_bilayer(0.9, 1.0, 0.2, [ 10 0 0 ], 0, pi/4)' )
...
for n in $(seq 0 9); do
	# Make a work directory for Matlab
    	workdir="/work/$LOGNAME/matlab/ds_hx_a0/${n}"
    	mkdir -p "$workdir"
    	cd "$workdir"
