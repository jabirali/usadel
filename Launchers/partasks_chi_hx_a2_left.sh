...
##################################################################
commands=( 'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -1.5208)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -1.4708)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -1.5208)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -0.9354)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -0.8854)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -0.8354)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -0.7354)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -0.6854)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -0.6354)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -0.0500)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -0.1000)'
           'critical_bilayer(1, 0.2, 0.2, [ 10 0 0 ], 2, -0.1500)' )
...
for n in $(seq 0 11); do
	# Make a work directory for Matlab
    	workdir="/work/$LOGNAME/matlab/chi_hx_a2L/${n}"
    	mkdir -p "$workdir"
    	cd "$workdir"
