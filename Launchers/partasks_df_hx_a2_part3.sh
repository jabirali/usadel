...
##################################################################
commands=( 'critical_bilayer(1, 0.52, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.55, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.57, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.62, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.65, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.67, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.72, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.75, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.77, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.82, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.85, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.87, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.92, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.95, 0.2, [ 10 0 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.97, 0.2, [ 10 0 0 ], 2, pi/4)' )
...
for n in $(seq 0 11); do
	# Make a work directory for Matlab
    	workdir="/work/$LOGNAME/matlab/df_hx_a2_part3/${n}"
    	mkdir -p "$workdir"
    	cd "$workdir"
