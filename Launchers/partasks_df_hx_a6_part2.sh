...
##################################################################
commands=( 'critical_bilayer(1, 0.15, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.17, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.19, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.22, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.25, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.27, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.32, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.35, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.37, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.42, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.45, 0.2, [ 10 0 0 ], 6, pi/4)'
           'critical_bilayer(1, 0.47, 0.2, [ 10 0 0 ], 6, pi/4)' )
...
for n in $(seq 0 11); do
	# Make a work directory for Matlab
    	workdir="/work/$LOGNAME/matlab/df_hx_a6_part2/${n}"
    	mkdir -p "$workdir"
    	cd "$workdir"
