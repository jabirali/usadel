...
##################################################################
commands=( 'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2, -1.57080)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2, -1.25664)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2, -0.94248)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2, -0.62832)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2, -0.31416)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2,  0.00000)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2,  0.31416)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2,  0.62832)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2,  0.94248)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2,  1.25664)'
           'critical_bilayer(1, 0.2, 0.2, [ 0 0 10 ], 2,  1.57080)' )
...
for n in $(seq 0 10); do
	# Make a work directory for Matlab
    	workdir="/work/$LOGNAME/matlab/chi_hz_a2/${n}"
    	mkdir -p "$workdir"
    	cd "$workdir"
