...
##################################################################
commands=( 'critical_bilayer(1, 0.2, 0.2, [  0.0000 -10.0000  0.0000 ], 0, 0)'
           'critical_bilayer(1, 0.2, 0.2, [  3.0902   0.0000 -9.5106 ], 0, 0)'
           'critical_bilayer(1, 0.2, 0.2, [  5.8779  -8.0902  0.0000 ], 0, 0)'
           'critical_bilayer(1, 0.2, 0.2, [  0.0000  -5.8779  8.0902 ], 0, 0)'
           'critical_bilayer(1, 0.2, 0.2, [  9.5106  -3.0902  0.0000 ], 0, 0)'
           'critical_bilayer(1, 0.2, 0.2, [ 10.0000   0.0000  0.0000 ], 0, 0)'
           'critical_bilayer(1, 0.2, 0.2, [  9.5106   3.0902  0.0000 ], 0, 0)'
           'critical_bilayer(1, 0.2, 0.2, [  5.8779   0.0000  8.0902 ], 0, 0)'
           'critical_bilayer(1, 0.2, 0.2, [  3.0902   9.5106  0.0000 ], 0, 0)'
           'critical_bilayer(1, 0.2, 0.2, [  3.5355   3.5355  8.6603 ], 0, 0)' )
...
for n in $(seq 0 10); do
	# Make a work directory for Matlab
    	workdir="/work/$LOGNAME/matlab/hxyz_a0/${n}"
    	mkdir -p "$workdir"
    	cd "$workdir"
