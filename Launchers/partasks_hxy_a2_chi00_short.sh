...
##################################################################
commands=( 'critical_bilayer(0.55, 0.2, 0.2, [ 00.0000 -10.0000 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 03.0902 -09.5106 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 05.8779 -08.0902 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 08.0902 -05.8779 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 09.5106 -03.0902 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 10.0000  00.0000 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 09.5106  03.0902 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 08.0902  05.8779 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 05.8779  08.0902 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 03.0902  09.5106 0 ], 2, 0)'
           'critical_bilayer(0.55, 0.2, 0.2, [ 00.0000  10.0000 0 ], 2, 0)' )
...
for n in $(seq 0 10); do
	# Make a work directory for Matlab
    	workdir="/work/$LOGNAME/matlab/hxy_a2_chi00_short/${n}"
    	mkdir -p "$workdir"
    	cd "$workdir"
