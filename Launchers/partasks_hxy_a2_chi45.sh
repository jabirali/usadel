...
##################################################################
commands=( 'critical_bilayer(1, 0.2, 0.2, [ 0.00000 -1.00000 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 0.30902 -0.95106 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 0.58779 -0.80902 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 0.80902 -0.58779 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 0.95106 -0.30902 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 1.00000  0.00000 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 0.95106  0.30902 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 0.80902  0.58779 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 0.58779  0.80902 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 0.30902  0.95106 0 ], 2, pi/4)'
           'critical_bilayer(1, 0.2, 0.2, [ 0.00000  1.00000 0 ], 2, pi/4)' )
...
for n in $(seq 0 10); do
	# Make a work directory for Matlab
    	workdir="/work/$LOGNAME/matlab/$(basename -s .sh $0)/${n}"
    	mkdir -p "$workdir"
    	cd "$workdir"
